...
object HealAction : SmartphoneAction {
    override val id = "${CobblemonSmartphone.ID}:heal"
    override val texture = ResourceLocation.fromNamespaceAndPath(CobblemonSmartphone.ID, "textures/gui/buttons/heal.png")
    override val hoverTexture = ResourceLocation.fromNamespaceAndPath(CobblemonSmartphone.ID, "textures/gui/buttons/heal_hover.png")

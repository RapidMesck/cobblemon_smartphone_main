...
object EnderAction : SmartphoneAction {
    override val id = "${CobblemonSmartphone.ID}:cloud"
    override val texture = ResourceLocation.fromNamespaceAndPath(CobblemonSmartphone.ID, "textures/gui/buttons/cloud.png")
    override val hoverTexture = ResourceLocation.fromNamespaceAndPath(CobblemonSmartphone.ID, "textures/gui/buttons/cloud_hover.png")
